...
void MarginInnerProductKernelLauncher(Dtype* bottom_data, Dtype* weight, int m_value, Dtype lambda_, const int* label, Dtype* x_norm_data, Dtype* sign_0_data, Dtype* sign_1_data, Dtype* sign_2_data, Dtype* sign_3_data, Dtype* sign_4_data, Dtype* cos_theta_data, Dtype* cos_theta_quadratic_data, Dtype* cos_theta_cubic_data, Dtype* cos_theta_quartic_data, Dtype* top_data){

}

void MarginInnerProductGradKernelLauncher(Dtype* bottom_data, Dtype* weight, int m_value, Dtype lambda_, const int* label, Dtype* x_norm_data, Dtype* sign_0_data, Dtype* sign_1_data, Dtype* sign_2_data, Dtype* sign_3_data, Dtype* sign_4_data, Dtype* cos_theta_data, Dtype* cos_theta_quadratic_data, Dtype* cos_theta_cubic_data, Dtype* cos_theta_quartic_data, Dtype* top_diff, Dtype* bottom_diff, Dtype* weight_diff{
