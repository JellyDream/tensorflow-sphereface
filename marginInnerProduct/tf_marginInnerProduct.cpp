...
class MarginInnerProductGpuOp : public OpKernel{
    ...
    public:
        ...
        void Compute(OpKernelContext* context) override{
            ...
            OP_REQUIRES_OK(context, context->allocate_output(0, TensorShape{M_ , N_},&output_tensor));
            auto top_data = &output_tensor->flat<Dtype>()(0);
            caffe_gpu_set(M_ * N_, (Dtype)0., top_data);
    ...
    MarginInnerProductKernelLauncher(M_, N_, K_,bottom_data, weight, m_value, lambda_, label, x_norm_data, sign_0_data, sign_1_data, sign_2_data, sign_3_data, sign_4_data, cos_theta_data, cos_theta_quadratic_data, cos_theta_cubic_data,  cos_theta_quartic_data, top_data);
    }
};
REGISTER_KERNEL_BUILDER(Name("MarginInnerProduct").Device(DEVICE_GPU), MarginInnerProductGpuOp);
